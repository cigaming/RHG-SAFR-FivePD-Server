...
local emotes = {
    ...
    ['cpcc'] = "CODE_HUMAN_POLICE_CROWD_CONTROL",
    ['cpiv'] = "CODE_HUMAN_POLICE_INVESTIGATE",
    ...
    ['drunk'] = "WORLD_HUMAN_BUM_STANDING",
    ['traffic'] = "WORLD_HUMAN_CAR_PARK_ATTENDANT",
    ['pups'] = "WORLD_HUMAN_PUSH_UPS",
    ['sups'] = "WORLD_HUMAN_SIT_UPS",
    ['satu'] = "WORLD_HUMAN_HUMAN_STATUE",
    ['guard'] = "WORLD_HUMAN_STAND_GUARD",
}
