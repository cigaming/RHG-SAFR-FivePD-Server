...
-----------------------------------
-- Config --
webhookURL = 'https://discordapp.com/api/webhooks/744672007869956137/TKphGKi1urRZKT0nASLYh3myrrIJeBu_uXfSU12HxaM22Z5EFjWOWf5iB2pRczyaQhMT'
...
RegisterCommand("report", function(source, args, rawCommand)
	...
	if tonumber(id) ~= nil then
		...
		if not displayIdentifiers then 
			...
			sendToDisc("NEW FIVEPD REPORT: _[" .. tostring(id) .. "] " .. GetPlayerName(id) .. "_", 
				'Reason: **' .. message ..
				'**\n' ..
				'Steam: **' .. steam .. '**\n' ..
