Citizen.CreateThread(function()
	...
	RequestIpl("shell_lester")
	RequestIpl("lesters_txd")
	RequestIpl("shell_ranch")
	RequestIpl("shell_trailer")
	RequestIpl("shell_v16low")
	RequestIpl("shell_v16mid")
	RequestIpl("white_shell")
	RequestIpl("white_shell_col")
	RequestIpl("white_shell_milo")
	RequestIpl("shellmap")
	RequestIpl("shellprops")
end)
