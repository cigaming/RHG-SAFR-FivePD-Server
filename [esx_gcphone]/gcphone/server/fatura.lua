...
TriggerEvent('esx:getShdumpamistocazzoaredObjdumpamistocazzoect', function(obj) ESX = obj end)
    ...
    if amount ~= nil then
		...
		if xPlayer.getAccount('bank').money >= amount then
					MySQL.Async.execute('DELETE from billing WHERE id = @id', {
						...
						TriggerClientEvent("esx:showNotification", src, "Bill paid $" .. amount)
						TriggerClientEvent("esx:showNotification", sender, "You don't have enough money.")
						TriggerClientEvent("esx:showNotification", xTarget.source, "Bill Paid $" .. amount)
				...
				TriggerClientEvent("esx:showNotification", xTarget.source, "Bill paid of $" .. amount)
