...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'StevesTacos', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'StevesTacos', _U('alert_StevesTacos'), true, true)
TriggerEvent('esx_society:registerSociety', 'StevesTacos', 'StevesTacos', 'society_StevesTacos', 'society_StevesTacos', 'society_StevesTacos', {type = 'public'})
...
AddEventHandler('esx_mafiajob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_StevesTacos', function(inventory)
...
ESX.RegisterServerCallback('esx_mafiajob:getArmoryWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_StevesTacos', function(store)
...
ESX.RegisterServerCallback('esx_mafiajob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_StevesTacos', function(account)
