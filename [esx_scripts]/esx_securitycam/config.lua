...
Config.Zones = {
	Cameras = {
		Pos   = {x = 906.691, y = -151.53, z = 82.495},
...
Config.Locations = {
	...
	whiteCamLabel = {label = _U('white_field')},
		fieldCameras = {
			{label = _U('wcam1'), x = 2397.26, y = 3314.084, z = 51.607, r = {x = -0.0, y = -0.0, z = -50.01}, canRotate = true},
			{label = _U('gcam1'), x = 334.922, y = 4373.167, z = 64.394, r = {x = -180, y = -180, z = 24.83}, canRotate = true},
			{label = _U('mcam1'), x = -135.858, y = 136.466, z = 80.571, r = {x = -0.01, y = -0.01, z = 19.32}, canRotate = true}
		},
	}
}
