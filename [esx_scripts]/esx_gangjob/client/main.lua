...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_gangjob:getFineList', function(fines)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_gangjob:getVehicleInfos', function(infos)
  ...
  ESX.TriggerServerCallback('esx_gangjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_gangjob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_gangjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_gangjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_gangjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_gangjob:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_gangjob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.GangStations[station].Helicopters
...
AddEventHandler('esx_gangjob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_gangjob:hasEnteredEntityZone', function(entity)
...
AddEventHandler('esx_gangjob:hasExitedEntityZone', function(entity)
...
AddEventHandler('esx_gangjob:handcuff', function()
...
AddEventHandler('esx_gangjob:drag', function(cop)
...
AddEventHandler('esx_gangjob:putInVehicle', function()
...
AddEventHandler('esx_gangjob:OutVehicle', function(t)
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_gangjob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_gangjob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
