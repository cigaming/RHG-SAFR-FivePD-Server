...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'Woodyguns', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'Woodyguns', _U('alert_Woodyguns'), true, true)
TriggerEvent('esx_society:registerSociety', 'Woodyguns', 'Woodyguns', 'society_Woodyguns', 'society_Woodyguns', 'society_Woodyguns', {type = 'public'})
...
AddEventHandler('esx_mafiajob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_Woodyguns', function(inventory)
...
ESX.RegisterServerCallback('esx_mafiajob:getArmoryWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_Woodyguns', function(store)
...
ESX.RegisterServerCallback('esx_mafiajob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_Woodyguns', function(account)
