...
function loadListVehiclePage(elementPages, page)
  ...
  RegisterNetEvent("city_pound")
AddEventHandler("city_pound", function(args)
  ESX.ShowNotification('Thank you for cleaning the city you have been paid £100')
end)

RegisterNetEvent("city_pound2")
AddEventHandler("city_pound2", function(args)
  ESX.ShowNotification('You need to wait a few minutes')
end)