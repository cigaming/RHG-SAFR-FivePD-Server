Locales['en'] = {
	...
	['meet_ls']					= 'go to the delivery point in DOC',
	['meet_bc']					= 'go to the delivery point in DOC',
	['meet_del']				= 'go to the delivery point',
	['return_depot']			= 'return to the depot.',
	['blip_job']				= 'DOC',
	['blip_delivery']			= 'DOC : Delivery',
	['blip_goal']				= 'DOC : Delivery point',
	['blip_depot']				= 'DOC : depot',
}