Config.Jobs.fueler = {
	...
	Zones = {
		...
		OilFarm = {
			Pos = {x = -3042.893, y = 7479.008, z = 50.699},
		...
		VehicleSpawner = {
			Pos = {x = 552.769, y = -2320.939, z = 5.818},
			Size = {x = 3.0, y = 3.0, z = 2.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
			Blip = false,
			...
			Type = 'vehspawner',
			Spawner = 1,
			Hint = 'Press ~INPUT_PICKUP~ to call vehicle',
			Caution = 20000,
			GPS = {x = 570.627, y = -2341.16, z = 6.533}
		},

		VehicleSpawnPoint = {
			Pos = {x = 570.627, y = -2341.16, z = 6.533},
