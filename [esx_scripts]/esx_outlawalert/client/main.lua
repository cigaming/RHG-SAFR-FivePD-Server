...
Citizen.CreateThread(function()
	while true do
		...
		elseif IsPedShooting(playerPed) and Config.GunshotAlert then
			...
			-- Petrol Can = 883325847  FIREEXTINGUISHER = 101631238   FLARE = 1233104067    FLAREGUN = 1198879012    STUNGUN = 911657153
			if Weapon ~= 1233104067 and Weapon ~= 1198879012 and Weapon ~= 911657153 then
