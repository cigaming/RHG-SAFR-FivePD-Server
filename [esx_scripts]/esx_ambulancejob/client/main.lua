    ...
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'vehicle_spawner',
      {
        ...
        elements = {
          ...
          {label = _U('Firetruck w/ Water Cannon'),  value = 'firetruk'},
          {label = _U('Firetruck'),  value = 'firetruk2'},
          {label = _U('Heavy Rescue'),  value = 'fireheavy'},
          {label = _U('Laddertruck'),  value = 'laddertruk'},
          {label = _U('BC Explorer'),  value = 'fireexp'},
        },
      },
      function(data, menu)
        menu.close()
