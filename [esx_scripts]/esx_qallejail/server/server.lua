...
AddEventHandler("esx-qalle-jail:breakout", function()

	TriggerClientEvent("esx-qalle-jail:breakout2", -1)
end)
...
AddEventHandler("esx-qalle-jail:jailPlayer", function(targetSrc, jailTime, jailReason)
	...
	TriggerClientEvent("esx:showNotification", src, GetPlayerName(targetSrc) .. " Jailed for " .. jailTime .. " months!")
end)
...
AddEventHandler("esx-qalle-jail:prisonWorkReward", function()
	...
	TriggerClientEvent("esx:showNotification", src, "You earned time of your sentence.")
end)
